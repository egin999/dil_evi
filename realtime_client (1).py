...
Kulaklık setup'ı için ayarlar:
- Normal VAD (threshold 0.6, silence 700ms) — doğal akış
- Barge-in açık, mic muting yok
- Language hint: "en" — Whisper Rusça/saçma halüsinasyonu azalır
"""
import asyncio
import base64
import json
    ...
    async def connect(self):
        ...
        await self._send({
            ...
            "session": {
                ...
                # Language hint YOK — Whisper konuştuğun dili kendi tespit etsin.
                # Böylece Türkçe "merhaba" → "Merhaba" olarak transkribe edilir,
                # fonetik olarak "Never" sanılmaz.
                "input_audio_transcription": {
                    "model": "whisper-1",
                },
                # Normal dengeli VAD — eko yok varsayımıyla.
                "turn_detection": {
                    "type": "server_vad",
                    "threshold": 0.5,
